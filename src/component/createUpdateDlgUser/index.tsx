...
import { handleUpdateUser, handleCreateUser } from '@/service/users';
...
export default function CreateUpdateDialog({open, onClose, onConfirm, actionDialog, dataDialog, disabled, ...props}: PropDialog) {
    ...
    <React.Fragment>
      ...
      >
        <DialogTitle id="alert-dialog-title">
          {actionDialog === 'CREATE' ? 'Create new user' : 'Update current user'}
        </DialogTitle>
        <Divider/>
        <DialogContent>
